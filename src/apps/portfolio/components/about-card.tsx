  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center flex-1">
        <div className="w-[80%] mx-auto mt-[-24px] flex items-center justify-center font-bold tracking-tight gap-8pxr">
          <p className="text-violet text-40pxr tablet:text-[4vw]">front-end</p>
          <p className="text-primary text-48pxr tablet:text-[6vw]">web developer</p>
        </div>
      </div>
