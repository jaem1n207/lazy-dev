...
type StripModifier<V extends string, M extends string> = V extends `${infer L}${M}${infer A}`
  ? L
  : V;
...
declare function querySelector<T extends string>(selectors: T): QueryResult<T>;
